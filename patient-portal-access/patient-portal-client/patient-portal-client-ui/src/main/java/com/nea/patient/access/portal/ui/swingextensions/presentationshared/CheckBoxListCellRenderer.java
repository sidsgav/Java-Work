...
/**
 * This class can be used to allow a {@code JList} component to render a list of {@code JCheckbox}.
 * This class expects the parameter {@code value} as supplied in method
 * {@code getListCellRendererComponent} to implement interface {@code IListToggleComponent} to allow
 * the state of the {@code JCheckbox} to be displayed.
 **/
...
public final class CheckBoxListCellRenderer extends JCheckBox implements ListCellRenderer {
   ...
   */
  public CheckBoxListCellRenderer(final boolean showListSelection) {
    super();
   ...
   *         the component to return is {@code JCheckBox}.
   */
  @Override
